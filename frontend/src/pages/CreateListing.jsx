        ...
        <div className="flex flex-col flex-1 gap-2  ml-5">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 border border-green-500 text-green-500 uppercase rounded-lg hover:shadow-lg disabled:opacity-80"
            >
            ...
            formData.imageUrls.map((url, index) => (
              <div key={url} className="flex justify-between p-3  items-center">
                ...
                <button
                  ...
                  className="p-3 border border-red-700 text-red-700 uppercase rounded-lg hover:shadow-lg disabled:opacity-80"
                >
                  Delete
                </button>
              </div>
